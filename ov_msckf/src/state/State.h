...
public:
    ...
    // 模型概率
    double p_huber1;       // Huber滤波器模型概率
     double p_huber2;
      double p_huber3; // 卡方滤波器模型概率
  /**
  ...
  State(const State& other)
      : _timestamp(other._timestamp),
        ...
        _imu(other._imu),
        _clones_IMU(other._clones_IMU),
        _features_SLAM(other._features_SLAM),
        _calib_dt_CAMtoIMU(other._calib_dt_CAMtoIMU),
        _calib_IMUtoCAM(other._calib_IMUtoCAM),
        _cam_intrinsics(other._cam_intrinsics),
        _cam_intrinsics_cameras(other._cam_intrinsics_cameras),
        _calib_imu_dw(other._calib_imu_dw),
        _calib_imu_da(other._calib_imu_da),
        _calib_imu_tg(other._calib_imu_tg),
        _calib_imu_GYROtoIMU(other._calib_imu_GYROtoIMU),
        _calib_imu_ACCtoIMU(other._calib_imu_ACCtoIMU),
        _Cov(other._Cov),
        _variables(other._variables) {
    // 重新初始化 std::mutex
    // _mutex_state 不能被拷贝，因此需要重新初始化
  }
  /**
