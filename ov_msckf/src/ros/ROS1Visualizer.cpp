...
void ROS1Visualizer::setup_subscribers(std::shared_ptr<ov_core::YamlParser> parser) {
  ...
  //_nh.param<std::string>("topic_gps", gps_topic, "/gps");
  //ros::Subscriber subgps = _nh.subscribe(gps_topic, 10, callback_gps);
  std::string topic_gps;
  _nh->param<std::string>("topic_gps", topic_gps, "/gps");
sub_gps = _nh->subscribe(topic_gps, 50, &ROS1Visualizer::callback_gps, this);
